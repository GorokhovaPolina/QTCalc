...
// void ChertCalc::on_comboBox_1_activated(int index)
// {
//     QString inputNumber = ui->label->text();
//     int decimalNumber = 0;

//     // В зависимости от выбора пользователя в combobox выполняем соответствующий алгоритм перевода в десятичную систему
//     switch (index) {
//     case 0: // Двоичная система счисления
//         decimalNumber = binaryToDecimal(inputNumber);
//         break;
//     case 1: // Троичная система счисления
//         decimalNumber = ternaryToDecimal(inputNumber);
//         break;
//     }
// }
...
// {
//     if (index == 0) //двоичная сс
//     {

//     }
//     else if (index == 1) //троичная сс
//     {

//     }
//     else if (index == 2) //четверичная сс
//     {

//     }
//     else if (index == 3) //пятиричная сс
//     {

//     }
//     else if (index == 4) //шестиричная сс
//     {

//     }
//     else if (index == 5) //семиричная сс
//     {

//     }
//     else if (index == 6) //восьмиричная сс
//     {

//     }
//     else if (index == 7) //девятиричная сс
//     {

//     }
//     else if (index == 8) //десятиричная сс
//     {

//     }
//     else if (index == 9) //одиннадцатиричная сс
//     {

//     }
//     else if (index == 10) //двенадцатиричная сс
//     {

//     }
//     else if (index == 11) //тринадцатиричная сс
//     {

//     }
//     else if (index == 12) //четырнадцатиричная сс
//     {

//     }
//     else if (index == 13) //пятнадцатиричная сс
//     {

//     }
//     else if (index == 14) //шестнадцатиричная сс
//     {
